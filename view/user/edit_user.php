		...
		<div class ="table">
			...
			<div class ="row">
				<br>					
					...
					<div class ="error"><?php echo (isset($this->error['birthday'])?date('d-m-Y',strtotime($this->error['birthday'])) :'')?></div>
					<p><b>Sex:</b></p>
					<p><select name ="sex">
					...
					<div class ="error"><?php echo (isset($this->error['sex'])?$this->error['sex'] :'')?></div>
					<p><b>Address:</b></p>	
					...
					<div class ="error"><?php echo (isset($this->error['group_id'])?$this->error['group_id'] :'')?></div>
					<p><b>Email:</b></p>	
